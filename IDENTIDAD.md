...
|:---:|-----------|-----------------|----------|
| — | `NN` | los 2 últimos dígitos de mi cédula | 16 |
| 1 | Nombre de la tabla | `tbl_productos_base_` + `NN` | tbl_productos_base_16 |
| 2 | Puerto | `81` + `NN` | 8116 |
...
- **Plataforma:**  YouTube no listado                 <!-- Drive institucional / OneDrive / YouTube no listado -->
